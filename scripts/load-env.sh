...
set -euo pipefail
_ALLOWED_KEYS=' MODEL_DIR DRAFT_DIR CACHE_DIR GPU_DEVICES BIND_ADDRESS PORT CONTAINER_NAME SERVED_MODEL_NAME MAX_MODEL_LEN MAX_NUM_BATCHED_TOKENS MAX_NUM_SEQS GPU_MEMORY_UTILIZATION MAX_IMAGES_PER_PROMPT NCCL_DEBUG '
